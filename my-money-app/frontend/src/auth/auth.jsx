            ...
            <div className="login-box">
                ...
                <div className="login-box-body">
                    ...
                    <form onSubmit={handleSubmit(v => this.onSubmit(v))}>
                        ...
                        <Row>
                            <Grid cols="4">
                                <button type="submit" className="btn btn-primary btn-sm btn-block btn-flat">{loginMode ? 'Entrar' : 'Registrar'}</button>
                            </Grid>
                        </Row>
                    </form>
                    <br />
                    <a onClick={() => this.changeMode()}>
                        {`${loginMode ? 'Novo Usuário' : 'Já é cadastrado'}? ${loginMode ? 'Registre-se' : 'Entre'} aqui!`}
                    </a>
                </div>
                <Messages />
            </div>
